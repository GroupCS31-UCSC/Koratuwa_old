...
<link rel="stylesheet" type="text/css" href="<?php echo URLROOT; ?>/public/css/admin/admin_dashboard.css">
<!--
...
<div class="navigation">
  ...
  <div class="topnavbar">
    ...
    <div class="user">
      <img class="img-user" src="<?php echo URLROOT; ?>/img/apsara.jpg" alt="user">
    </div>
